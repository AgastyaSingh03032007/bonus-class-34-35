...
function draw() 
{
  ...
  //Write conditions to start the first fan will be temp should be more than 30 and power_gen > =8.
...
function makeRay()
{
   ...
   if (frameCount % 60 === 0) 
   {
    ...
    raysGroup.setLifetimeEach(134)
     ...
     rayGroups.overlap(pan1, charge1);
     rayGroups.overlap(pan2,charge2);
     rayGroups.overlap(g_house,temp_rise);
